...
const capabilityCards: Array<{ icon: LucideIcon; title: string; copy: string }> = [
  { icon: Mic, title: "Natural voice", copy: "Interruptible, fast, conversational" },
  { icon: Camera, title: "Camera-first", copy: "The live scene is always the hero" },
  { icon: ScanSearch, title: "Freeze + explain", copy: "Precise grounded visual analysis" }
];
